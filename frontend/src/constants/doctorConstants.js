...
export const DOCTOR_CATEGORY_LIST_REQUEST = "DOCTOR_CATEGORY_LIST_REQUEST";
export const DOCTOR_CATEGORY_LIST_SUCCESS = "DOCTOR_CATEGORY_LIST_SUCCESS";
export const DOCTOR_CATEGORY_LIST_FAIL = "DOCTOR_CATEGORY_LIST_FAIL";
